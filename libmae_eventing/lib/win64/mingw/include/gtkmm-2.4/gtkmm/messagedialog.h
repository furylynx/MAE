...
public:
  ...
  /** @newin{2,22}
   * @return A Gtk::VBox corresponding to the "message area" in the
   *  @a message_dialog.  This is the box where the dialog's primary and secondary
   ...
   * on the left for right-to-left languages).  See Gtk::Dialog::get_content_area()
