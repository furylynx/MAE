...
public class e_bone_vector {
  ...
  public void add(SWIGTYPE_p_e_bone x) {
    w_e_boneJNI.e_bone_vector_add(swigCPtr, this, SWIGTYPE_p_e_bone.getCPtr(x));
  }

  public SWIGTYPE_p_e_bone get(int i) {
    return new SWIGTYPE_p_e_bone(w_e_boneJNI.e_bone_vector_get(swigCPtr, this, i), false);
  }

  public void set(int i, SWIGTYPE_p_e_bone val) {
    w_e_boneJNI.e_bone_vector_set(swigCPtr, this, i, SWIGTYPE_p_e_bone.getCPtr(val));
  }
