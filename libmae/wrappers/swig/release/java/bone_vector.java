...
public class bone_vector {
  ...
  public void add(SWIGTYPE_p_bone x) {
    w_e_boneJNI.bone_vector_add(swigCPtr, this, SWIGTYPE_p_bone.getCPtr(x));
  }

  public SWIGTYPE_p_bone get(int i) {
    return new SWIGTYPE_p_bone(w_e_boneJNI.bone_vector_get(swigCPtr, this, i), false);
  }

  public void set(int i, SWIGTYPE_p_bone val) {
    w_e_boneJNI.bone_vector_set(swigCPtr, this, i, SWIGTYPE_p_bone.getCPtr(val));
  }
