...
public class HierarchyElement {
  ...
  public HierarchyElement(int id, String name, boolean torso_joint, boolean dummy) {
    this(MaeJavaJNI.new_HierarchyElement__SWIG_0(id, name, torso_joint, dummy), true);
  }

  public HierarchyElement(int id, String name, boolean torso_joint) {
    this(MaeJavaJNI.new_HierarchyElement__SWIG_1(id, name, torso_joint), true);
  }
