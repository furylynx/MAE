...
public class relationship_bow extends i_movement {
  ...
  protected relationship_bow(long cPtr, boolean cMemoryOwn) {
    super(w_e_boneJNI.relationship_bow_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public int get_column() {
    return w_e_boneJNI.relationship_bow_get_column(swigCPtr, this);
  }

  public long get_measure() {
    return w_e_boneJNI.relationship_bow_get_measure(swigCPtr, this);
  }

  public double get_beat() {
    return w_e_boneJNI.relationship_bow_get_beat(swigCPtr, this);
  }
  ...
  public String xml(long indent) {
    return w_e_boneJNI.relationship_bow_xml__SWIG_1(swigCPtr, this, indent);
  }
  ...
  public i_movement recreate(int_int_map column_mapping, long measure, double beat, double duration) {
    long cPtr = w_e_boneJNI.relationship_bow_recreate(swigCPtr, this, int_int_map.getCPtr(column_mapping), column_mapping, measure, beat, duration);
    return (cPtr == 0) ? null : new i_movement(cPtr, true);
  }

  public String str() {
    return w_e_boneJNI.relationship_bow_str(swigCPtr, this);
  }
