...
public class direction_symbol extends i_symbol {
  ...
  protected direction_symbol(long cPtr, boolean cMemoryOwn) {
    super(w_e_boneJNI.direction_symbol_SWIGSmartPtrUpcast(cPtr), true);
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwnDerived) {
        ...
        w_e_boneJNI.delete_direction_symbol(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public e_level get_vertical() {
    return e_level.swigToEnum(w_e_boneJNI.direction_symbol_get_vertical(swigCPtr, this));
  }

  public e_direction get_horizontal() {
    return e_direction.swigToEnum(w_e_boneJNI.direction_symbol_get_horizontal(swigCPtr, this));
  }

  public pin get_modification_pin() {
    long cPtr = w_e_boneJNI.direction_symbol_get_modification_pin(swigCPtr, this);
    return (cPtr == 0) ? null : new pin(cPtr, true);
  }

  public pin get_relationship_pin() {
    long cPtr = w_e_boneJNI.direction_symbol_get_relationship_pin(swigCPtr, this);
    return (cPtr == 0) ? null : new pin(cPtr, true);
  }

  public i_dynamics_sign get_dynamics() {
    long cPtr = w_e_boneJNI.direction_symbol_get_dynamics(swigCPtr, this);
    return (cPtr == 0) ? null : new i_dynamics_sign(cPtr, true);
  }

  public space_measurement get_space_measurement() {
    long cPtr = w_e_boneJNI.direction_symbol_get_space_measurement(swigCPtr, this);
    return (cPtr == 0) ? null : new space_measurement(cPtr, true);
  }

  public e_contact_hook get_contact_hook() {
    return e_contact_hook.swigToEnum(w_e_boneJNI.direction_symbol_get_contact_hook(swigCPtr, this));
  }
