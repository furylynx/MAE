...
#define BOOST_TEST_MODULE "discrete_frechet_distance"
...
BOOST_AUTO_TEST_CASE( equalsequence )
{
    ...
    std::shared_ptr<mae::math::discrete_frechet_distance<std::vector<double> > > warping = std::make_shared<mae::math::discrete_frechet_distance<std::vector<double> > >(distance_measure);
