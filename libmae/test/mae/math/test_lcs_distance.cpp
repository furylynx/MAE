...
#define BOOST_TEST_MODULE "lcs_distance"
...
BOOST_AUTO_TEST_CASE( equalsequence )
{
    ...
    std::shared_ptr<mae::math::lcs_distance<std::vector<double> > > warping = std::make_shared<mae::math::lcs_distance<std::vector<double> > >(distance_measure, true);
...
BOOST_AUTO_TEST_CASE( distance )
{
    ...
    std::vector<std::vector<double> > sequence2 = {{1}, {2}, {1}, {3}, {6}, {7}, {9}};
