...
{
    mae::fl::laban::aligned_laban_sequence_comparator similarity_measure;
...
BOOST_AUTO_TEST_CASE( aligned_laban_sequence )
{
    ...
    mae::fl::laban::aligned_laban_sequence_comparator similarity_measure (std::make_shared<mae::math::aligned_distance<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::math::dtw<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::fl::laban::movement_comparator>(), 0, true)), true, 1);
...
BOOST_AUTO_TEST_CASE( aligned_laban_sequence_gap_hold2 )
{
    ...
    mae::fl::laban::aligned_laban_sequence_comparator similarity_measure (std::make_shared<mae::math::aligned_distance<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::math::dtw<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::fl::laban::movement_comparator>(), 0, true)), true, 1, 0);
...
BOOST_AUTO_TEST_CASE( aligned_laban_sequence_gap_blur2 )
{
    ...
    mae::fl::laban::aligned_laban_sequence_comparator similarity_measure (std::make_shared<mae::math::aligned_distance<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::math::dtw<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::fl::laban::movement_comparator>(), 0, true)), true, 1, 2);
...
BOOST_AUTO_TEST_CASE( aligned_laban_sequence_gap_blur4 )
{
    ...
    mae::fl::laban::aligned_laban_sequence_comparator similarity_measure (std::make_shared<mae::math::aligned_distance<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::math::dtw<std::shared_ptr<mae::fl::laban::i_movement> > >(std::make_shared<mae::fl::laban::movement_comparator>(), 0, true)), true, 1, 4);
