...
namespace mae
{
	namespace fl
	{
		namespace laban
		{
			...
			std::shared_ptr<decision_value<i_movement, std::vector<std::vector<std::shared_ptr<i_movement> > > > > rewriting_rules_reader::read_rule(xmlpp::Node* node, std::shared_ptr<xmlpp::Node::PrefixNsMap> namespace_map, std::string nsp)
			{
			...
			std::vector<std::shared_ptr<i_movement> > rewriting_rules_reader::read_rule_sequence(xmlpp::Node* node, std::shared_ptr<xmlpp::Node::PrefixNsMap> namespace_map, std::string nsp)
			{
			...
			std::shared_ptr<i_movement> rewriting_rules_reader::read_element(xmlpp::Node* node, std::shared_ptr<xmlpp::Node::PrefixNsMap> namespace_map, std::string nsp)
			{
