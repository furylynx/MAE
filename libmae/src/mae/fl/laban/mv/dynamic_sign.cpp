            ...
            namespace mv
            {
                ...
                std::string dynamic_sign::svg(std::string identifier, draw_rect rect, bool left, svg_style style) const
                {
                    ...
                    if (dynamic_ == e_dynamic::STRONG || dynamic_ == e_dynamic::GENTLE || dynamic_ == e_dynamic::RELAXED || dynamic_ == e_dynamic::LIMP)
                    {
                        ...
                        sstr << "\t\t\tstyle=\"fill:#" << style.get_fill_color() << ";fill-opacity:1;stroke:#" << style.get_draw_color() << ";stroke-width:"
                             << style.get_reduced_stroke_width() << "pt;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none\" />" << std::endl;
                        ...
                        {
                            sstr
                                    << "\t\t\tstyle=\"fill:#" << style.get_fill_color() << ";fill-opacity:1;stroke:#" << style.get_draw_color() << ";stroke-width:"
                                    << style.get_reduced_stroke_width() << "pt;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none\" />"
                                    << std::endl;
                        }
                        else
                        {
                            sstr
                                    << "\t\t\tstyle=\"fill:#" << style.get_draw_color() << ";fill-opacity:1;stroke:#" << style.get_draw_color() << ";stroke-width:"
                                    << style.get_reduced_stroke_width() << "pt;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none\" />"
                                    << std::endl;
                        }
                    ...
                    {
                        sstr << "\t\t<path" << std::endl;
                        sstr << "\t\t\td=\"M " << posx << "," << posy + height / 10.0 << " " << posx + width / 2.0 << "," << posy - height / 10.0 << " C " << posx + width / 2.0
                             << "," << posy + 4 * height / 10.0 << " " << posx + 6 * width / 10.0 << "," << posy + 7 * height / 10.0 << " " << posx + width << "," << posy + height
                             << " " << posx + 4 * width / 10.0 << "," << posy + 8 * height / 10.0 << " " << posx << "," << posy + height / 2.0 << " " << posx << ","
                             << posy + height / 10.0 << " Z\"" << std::endl;
                        ...
                        {
                            sstr << "\t\t\tstyle=\"fill:#" << style.get_fill_color() << ";stroke:#" << style.get_draw_color() << ";stroke-width:"
                                 << style.get_reduced_stroke_width() << "pt;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1\" />" << std::endl;
                        }
                        else
                        {
                            sstr << "\t\t\tstyle=\"fill:#" << style.get_draw_color() << ";stroke:#" << style.get_draw_color() << ";stroke-width:"
                                 << style.get_reduced_stroke_width() << "pt;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1\" />" << std::endl;
                        }
                    ...
                    else if (dynamic_ == e_dynamic::UNEMPHASIZED || dynamic_ == e_dynamic::EMPHASIZED)
                    {
                        ...
                        sstr << "\t\t\td=\"M " << posx + width << "," << posy + height << " C " << posx + 2 * width / 3.0 << "," << posy + height << " " << posx << ","
                             << posy + height / 3.0 << " " << posx << "," << posy << "\"" << std::endl;
                        ...
                        sstr << "\t\t\tid=\"" << identifier << "-dynamic-curve\"" << std::endl;
                        sstr << "\t\t\tstyle=\"fill:none;stroke:#" << style.get_draw_color() << ";stroke-width:" << style.get_reduced_stroke_width()
                             << "pt;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1\" />" << std::endl;
                        ...
                        sstr << ";fill-opacity:1;stroke:#" << style.get_draw_color() << ";stroke-width:" << style.get_reduced_stroke_width()
                             << "pt;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none\" />"
                             << std::endl;
                    }
