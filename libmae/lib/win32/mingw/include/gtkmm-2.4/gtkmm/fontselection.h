...
public:
   ...
   * 
   * @newin{2,14}
   * @return A Pango::FontFamily representing the selected font
   * family. Font families are a collection of font faces. The 
   * returned object is owned by @a fontsel and must not be modified 
   * or freed.
   */
   ...
   * 
   * @newin{2,14}
   * @return A Pango::FontFace representing the selected font 
   * group details. The returned object is owned by @a fontsel and
...
public:
   ...
   * 
   * @newin{2,14}
   * @return The Gtk::Widget used in the dialog for the 'OK' button.
   */
   ...
   * 
   * @newin{2,14}
   * @return The Gtk::Widget used in the dialog for the 'Cancel' button.
   */
