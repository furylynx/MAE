...
struct comparator_info { int id; std::string name; std::string description; std::shared_ptr<mae::math::i_aligned_similarity_measure<std::shared_ptr<mae::fl::laban::laban_sequence> > > comparator; };

comparator_info initialize_comparator_info(int id, std::string name, std::string description, std::shared_ptr<mae::math::i_aligned_similarity_measure<std::shared_ptr<mae::fl::laban::laban_sequence> > > comparator)
{
