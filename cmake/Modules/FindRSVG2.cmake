...
if(${RSVG2_PKGCONF_VERSION} VERSION_LESS ${RSVG2_FIND_VERSION_MAJOR}.${RSVG2_FIND_VERSION_MINOR}.${RSVG2_FIND_VERSION_PATCH})
    ...
    if (${RSVG2_FIND_REQUIRED})
        message(SEND_ERROR "Library librsvg-2.0 found in version ${RSVG2_PKGCONF_VERSION} but version ${RSVG2_FIND_VERSION_MAJOR}.${RSVG2_FIND_VERSION_MINOR}.${RSVG2_FIND_VERSION_PATCH} is required.")
    else()
        set(RSVG2_LIBRARIES)
    ...
    if(RSVG2_PKGCONF_FOUND)
        ...
        if (${RSVG2_FIND_REQUIRED})
            message(SEND_ERROR "Library librsvg not found.")
        else()
            set(RSVG2_LIBRARIES)
            set(RSVG2_INCLUDE_DIRS)
            set(RSVG2_VERSION)
