...
public class DeviceInfoVector {
  ...
  public DeviceInfoVector(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(DeviceInfoVector obj) {
  ...
  public void pushBack(DeviceInfo x) {
    MaeNiteJavaJNI.DeviceInfoVector_pushBack(swigCPtr, this, DeviceInfo.getCPtr(x), x);
  }

  public DeviceInfo get(int i) {
    long cPtr = MaeNiteJavaJNI.DeviceInfoVector_get(swigCPtr, this, i);
    return (cPtr == 0) ? null : new DeviceInfo(cPtr, true);
  }

  public void set(int i, DeviceInfo val) {
    MaeNiteJavaJNI.DeviceInfoVector_set(swigCPtr, this, i, DeviceInfo.getCPtr(val), val);
  }
