...
*                                                                            *
*****************************************************************************/
#ifndef _XN_PLATFORM_WIN32MINGW_H_
#define _XN_PLATFORM_WIN32MINGW_H_
...
//---------------------------------------------------------------------------
#define XN_PLATFORM XN_PLATFORM_WIN32MINGW
#define XN_PLATFORM_STRING "Win32-MinGW"
...
//#define XN_THREAD_STATIC __declspec(thread) //former usage!
...
//#define XN_CALLBACK_TYPE XN_STDCALL //former usage
#define XN_CALLBACK_TYPE 

/** The C and C++ calling convension. */
//#define XN_C_DECL __cdecl //former usage
#define XN_C_DECL
...
//#define XN_ASSERT(x)	_ASSERTE(x) //former usage
#define XN_ASSERT(x)
...
#endif //_XN_PLATFORM_WIN32MINGW_H_
