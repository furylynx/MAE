...
echo 'pkgconfig_DATA = libmae_nite.pc' >> Makefile.am 
...
echo '\n'$LIBLA'_LIBADD = $(LIBMAE_LIBS) $(LIBOPENNI_LIBS)' >> Makefile.am 
echo $LIBLA'_CPPFLAGS = $(LIBMAE_CFLAGS) $(LIBOPENNI_CFLAGS)' >> Makefile.am 
...
echo 'prefix=@prefix@' > libmae_nite.pc.in
echo 'exec_prefix=@exec_prefix@' >> libmae_nite.pc.in
echo 'libdir=@libdir@' >> libmae_nite.pc.in
echo 'includedir=@includedir@' >> libmae_nite.pc.in

echo 'Name: libmae_nite' >> libmae_nite.pc.in
echo 'Description: NiTE controller of the Movement Analysis Engine (MAE) for analyzing movement using depth sensors and Labanotation.' >> libmae_nite.pc.in
echo 'URL: https://github.com/furylynx/MAE' >> libmae_nite.pc.in
echo 'Version: @VERSION@' >> libmae_nite.pc.in
echo 'Requires: libmae >= 0.9.0, libopenni >= 1.5.4.0' >> libmae_nite.pc.in
echo 'Libs: -L${libdir} -lmae_nite' >> libmae_nite.pc.in
echo 'Cflags: -I${includedir}' >> libmae_nite.pc.in
