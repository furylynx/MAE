...
src/mae/nite/%.o: ../src/mae/nite/%.cpp
	...
	g++ -std=c++0x -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include/ -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed/ -I"/sda7/data/workspace-git/MAE/libmae/src" -I/usr/include/c++/4.8/ -I/usr/include/ni/ -I/usr/include/ -I/usr/include/nite/ -I/usr/include/x86_64-linux-gnu/c++/4.8/bits -I/usr/local/include -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/x86_64-linux-gnu/ -O3 -Wall -c -fmessage-length=0 -Wno-reorder -Wno-pragmas -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
